...
<div id="page-wrapper">
      ...
      <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              <a href="<?php echo base_url(); ?>/admin/activate_tickets/<?php echo $row->ticket_no;?>" onClick="return confirm('Activate Tickets?')" class="fa fa-ticket" style="font-size: 14pt;color:orange;"></a>
              <a href="<?php echo base_url(); ?>/admin/update_ticket_v/<?php echo $row->ticket_no;?>" class="fa fa-pencil-square-o" style="font-size: 14pt;color: green;margin-left: 10px;"></a>
              <a href="<?php echo base_url(); ?>/admin/delete_ticket/<?php echo $row->ticket_no;?>" onClick="return confirm('Are you sure you want to delete?')" class="fa fa-trash" style="font-size: 14pt;color:red;margin-left: 10px;"></a>
            </td>
          </tr>
          <?php 
          }
    ...
    <div class="row">
      ...
      <thead>
        ...
        <tbody>
        <?php
          foreach ($each_ticket->result() as $row ) {
        ?>
         <tr>
           ...
           <td>
           <a href="<?php echo base_url('admin/delete_each_ticket/'.$row->ticket_details_no); ?>" onClick="return confirm('Are you sure you want to delete?')" class="fa fa-trash" style="font-size: 14pt;color:red;margin-left: 10px;"></a>
           </td>
         </tr>
        <?php 
          }
