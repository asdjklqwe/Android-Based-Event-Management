            ...
            <div class="form-group">
              ...
              &nbsp;
                 ...
                 <div class="form-group">
                  ...
                  <div class="col-sm-10">
                   <input type="date" class="form-control" name="start_date" id="startdate" min="<?php echo $date_today; ?>" required="required" value="<?php echo $row->startdate; ?>">
                  </div>    
                  ...
                  <input type="date" class="form-control" name="end_date" id="enddate" min="<?php echo $date_today; ?>" required="required" value="<?php echo $row->enddate; ?>">
                  </div>    
                  </div>
